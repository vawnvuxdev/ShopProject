package com.evanshop.admin.currency;
...
public class CurrencyRepoTests {
	...
	public void testCreateCurrencies() {
		...
		List<Currency> listCurrencies = Arrays.asList(
				...
				new Currency("Bristish Pound", "£", "GPB"),
	...
	public void testListAll() {
		List<Currency> listByNameAsc = repo.findAllOrderByNameAsc();
		
		listByNameAsc.forEach(System.out::println);
		
		assertThat(listByNameAsc.size()).isGreaterThan(0);
