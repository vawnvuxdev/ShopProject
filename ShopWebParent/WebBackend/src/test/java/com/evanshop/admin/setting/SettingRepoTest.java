...
//		Setting siteName = new Setting("SITE_NAME", "Shopevan", SettingCategory.GENERAL);
		Setting siteLogo = new Setting("SITE_LOGO", "springboot-logo.png", SettingCategory.GENERAL);
		Setting siteCopyright = new Setting("COPYRIGHT", "Copyright (C) 2021 Shopevan Ltd", SettingCategory.GENERAL);
		
		repo.saveAll(List.of(siteLogo, siteCopyright));
